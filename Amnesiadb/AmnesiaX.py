...
'''.strip().encode()
    ...
    def encrypt3(self):
        ...
        self.code = f'# Amnesia base64, lzma; exec(compile(lzma.decompress(base64.b64decode({data})), "<string>", "exec"))'.encode()
